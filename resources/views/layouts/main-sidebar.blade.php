        ...
        <div class="app-sidebar__user clearfix">
            <div class="dropdown user-pro-body">
                ...
                <div class="user-info">
                    ...
                    <span class="mb-0 text-muted" style="width: 100%; text-align">{{ Auth::user()->email }}</span>
                </div>
            </div>
        </div>
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" ><svg
                            xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                    ...
                    <ul class="slide-menu">
                            ...
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'archievs')) }}">ارشيف الفواتير</a></li>
                    </ul>
                </li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'ReportInvoices')) }}">تقارير الفواتير</a>
                            </li>
