					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left"> <a href="/markall">قراءة الكل </a>  </span>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 " >
											  عدد الاشعارات الغير مقروء 
											<h3 id="count_notifications">  {{ Auth()->user()->unreadNotifications->count() }}</h3>
											</p>
									</div>
									<div class="main-notification-list Notification-scroll">
										<a class="d-flex p-3 border-bottom" href="#">
											...
											<div id="unreadnotifies"> 
											@foreach (auth()->user()->unreadNotifications as $notification) 

											<div class="mr-3">
												<h5 class="notification-label mb-1">
													<a href="{{url('invoicesdetails')}}/{{$notification->data['id']}}">{{$notification->data['title']}}
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="user-img" class="avatar avatar-xl brround" src="{{ URL::asset('assets/img/faces/18.png') }}"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user">
												{{-- <img alt="user-img" class="avatar avatar-xl brround"
                                               src="{{ URL::asset('assets/img/faces/18.png') }}"> --}}
											</div>
											<div class="mr-3 my-auto">
												<h6>{{Auth::user()->name}}</h6>
												<span style="width: 100%; text-align:center;"> {{Auth::user()->email}}</span>
											</div>
										</div>
									</div>
									<a class="dropdown-item" href=""><i class="bx bx-user-circle"></i>حسابي</a>
									<a class="dropdown-item" href=""><i class="bx bx-cog"></i> تعدبل الحساب</a>
